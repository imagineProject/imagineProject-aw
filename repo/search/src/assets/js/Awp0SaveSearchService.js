...
export let updateSavedSearchObjectAttributeValues = function( savedSearchObject ) {
    ...
    let dbValues = _.map( updatedSavedSearchObject.props.savedsearch_attr_values.dbValues, function( dbValue ) {
        return advancedSearchUtils.generateAccumulatedStringForAttributeValues( false, dbValue );
    } );
    let uiValues = _.map( updatedSavedSearchObject.props.savedsearch_attr_values.uiValues, function( uiValue ) {
        return advancedSearchUtils.generateAccumulatedStringForAttributeValues( true, uiValue );
    } );
    updatedSavedSearchObject.props.savedsearch_attr_values.dbValues = dbValues;
    updatedSavedSearchObject.props.savedsearch_attr_values.uiValues = uiValues;
...
export let initializeReviewAndExecuteSavedQuery = function( savedSearchObject, savedQuery, updateSavedSearchAttributeValues ) {
    ...
    savedQueryUpdated.uiValues = savedSearchObject.props.savedsearch_query.uiValues;
