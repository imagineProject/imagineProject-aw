...
/**
 * determining if to show the all, private and public options to the logged in user
 * @returns {Boolean} bool value
 */
export let setShowQueryOptionsVisibilityInSearchState = ( response ) => {
    return response && response.outputValues && response.outputValues.showQueryOptionsInAdvancedSearch && response.outputValues.showQueryOptionsInAdvancedSearch[0] === 'true';
};
...
const preferredAdvancedSearchService = {
    ...
    setShowQueryOptionsVisibilityInSearchState
};
