...
export let processAttributes = function( uiValues ) {
    ...
    for( var i = 0; i < attributeValues.length; i++ ) {
        ...
        if ( _.startsWith( attribute, '##' ) ) {
            ...
            let multipleValues = attributeValues[i + 1].split( ';' );
            let filterValue = '';
...
export let splitInternalAndDisplayNameUsingInternalKeyword = function( multiValues, getDisplayName, useSemicolonDelimiter ) {
    let filterValue = '';
