...
/**
 * Check if more license are about to load through pagination.
 * return true if all license are not loaded in data provider.
 * return false if all avaliable license are already loaded in dataprovider.
 * @param {*} response 
 * @param {*} data 
 * @returns true/false
 */
export let getMoreValuesExist = function( response ) {
    ...
    if( response.licensesOutput.availableLicenseList ) {
