...
/**
   ...
   */
export let getCurrentDefaultGroup = function( default_group ) {
    var currentdefaultGroupVal;
    let groupObject = cdm.getObject( default_group.dbValue );

    currentdefaultGroupVal = groupObject.props.object_string.uiValues[ 0 ];
