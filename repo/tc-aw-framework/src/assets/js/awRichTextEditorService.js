...
export let create = function( elementId, config ) {
    ...
    _loadRichTextEditor().then(
        function() {
            ...
            // Needs extra plugins to be loaded, if any
...
class AWCkeditor5 extends AwRichTextEditor {
    ...
    /**
     * Enables read-only mode for the rich text editor instance.
     *
     * @param {string} featureId - The identifier of the feature to enable read-only mode for.
     * @returns {boolean} - Returns true if the read-only mode was successfully enabled, otherwise false.
     */
    enableReadOnlyMode( featureId ) {
        return this._instance.enableReadOnlyMode( featureId );
    }

    /**
     * Disables the read-only mode for a specific feature.
     *
     * @param {string} featureId - The ID of the feature for which to disable read-only mode.
     * @returns {boolean} - Returns true if the read-only mode was successfully disabled, otherwise false.
     */
    disableReadOnlyMode( featureId ) {
        return this._instance.disableReadOnlyMode( featureId );
    }
}
