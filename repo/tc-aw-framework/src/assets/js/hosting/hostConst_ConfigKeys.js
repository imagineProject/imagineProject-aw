...
/**
 * The string to be used to allow Active Workspace Client to cache host data
 *
 *
 * @memberof hostConst_ConfigKeys
 *
 * @type {Boolean}
 */
export let ALLOW_CACHE_HOST_DATA = 'AllowCacheHostData';
...
/**
 * False to turn on the soa tunneling from host application by default
 * True to turn off the soa tunneling from host application, AW SOA will call AW restful service
 *
 * <P>
 ...
 * @type {Boolean}
 */
export let DISABLE_HS_ASYNC_SOA = 'DisableHostSOAAfterLogin';
...
/**
 * This flag indicates if hosted AW will hide global avatar
 * (default = 'false')
 *
 * @memberof hostConst_ConfigKeys
 *
 * @type {Boolean}
 */
export let HIDE_AVATAR = 'HideAvatar';
...
/**
 * This string contains group name for this session.
 * (default = '')
 *
 * @memberof hostConst_ConfigKeys
 *
 * @type {String}
 */
export let HOST_SESSION_GROUP = 'HostSessionGroup';

/**
 * This string contains locale for this session.
 * (default = '')
 *
 * @memberof hostConst_ConfigKeys
 *
 * @type {String}
 */
export let HOST_SESSION_LOCALE = 'HostSessionLocale';

/**
 * This string contains role name for this session.
 * (default = '')
 *
 * @memberof hostConst_ConfigKeys
 *
 * @type {String}
 */
export let HOST_SESSION_ROLE = 'HostSessionRole';

/**
 * This string contains Security Token for this session.
 * (default = '')
 *
 * @memberof hostConst_ConfigKeys
 *
 * @type {String}
 */
export let HOST_SESSION_SECURITY_TOKEN = 'HostSessionSecurityToken';

/**
 * This string contains username for this session.
 * (default = '')
 *
 * @memberof hostConst_ConfigKeys
 *
 * @type {String}
 */
export const HOST_SESSION_USER_NAME = 'HostSessionUserName';
...
/**
 * Display the App navigation menu?
 * <P>
 * Boolean = 'true' or 'false' (default = 'false')
 *
 * @memberof hostConst_ConfigKeys
 ...
 * @type {Boolean}
 */
export let SHOW_APP_SWITCHER = 'ShowAppSwitcher';
