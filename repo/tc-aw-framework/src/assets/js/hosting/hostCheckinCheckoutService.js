...
import { getSourceObjects } from 'js/tcSelectionUtils';
 ...
 * respectively.
 */
export let hostCheckinCheckout = function( localSelectionDat, activeSelection, operation ) {
    let modelObjs = getSourceObjects( localSelectionDat, activeSelection );
