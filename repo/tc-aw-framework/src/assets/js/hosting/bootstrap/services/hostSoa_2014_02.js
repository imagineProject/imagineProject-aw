        ...
        if( msg.getException() ) {
            ...
            if( soaResponseObj ) {
                if( logger.isTraceEnabled() ) {
                    ...
                    hostInteropSvc.log( hostInteropSvc.getCurrentTime( ) + 'hostSoa_2014_02: ' + 'handleResponse: ' + '.QName=' + qname + ' ' +
                    'cacheId=' + cacheId );
                }
...
export let post = function( serviceName, operationName, messageObj ) {
    ...
    if ( logger.isTraceEnabled() ) {
        ...
        hostInteropSvc.log( hostInteropSvc.getCurrentTime( date ) + 'hostSoa_2014_02: ' + 'post: ' + 'serviceName=' + serviceName + ' ' + 'operationName=' + operationName + ' ' + 'cacheId=' + cacheId );
    }
