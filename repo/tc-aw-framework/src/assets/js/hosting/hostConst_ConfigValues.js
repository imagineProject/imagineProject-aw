...
/**
 * ID of the Default host browser type
 *
 * @memberof hostConst_ConfigValues
 */
export let HOST_BROWSER_TYPE_DEFAULT = 'default';

/**
 * ID of the QT host browser type
 *
 * @memberof hostConst_ConfigValues
 */
export let HOST_BROWSER_TYPE_QT = 'QT';

/**
 * ID of the WebView2 host browser type
 *
 * @memberof hostConst_ConfigValues
 */
export let HOST_BROWSER_TYPE_WEBVIEW2 = 'WebView2';
...
export default exports = {
    ...
    HOST_BROWSER_TYPE_DEFAULT,
    HOST_BROWSER_TYPE_QT,
    HOST_BROWSER_TYPE_WEBVIEW2
};
