 ...
 * @memberof hostConst_Services_Solution
 */
export let CS_FILE_UPLOAD_SVC = 'splm.browserinterop.solutions.services.fileupload.FileUpload.client';
...
/**
 * Called by the client to tell the host that file upload is completed
 * <P>
 * <B>Param:</B> {@link GetFileUploadResponseMsg} Information about the status of file upload
 * <P>
 * <B>Return:</B> (none)
 *
 * @memberof hostConst_Services
 */
export let HS_FILE_UPLOAD_RESPONSE = 'splm.browserinterop.solutions.services.fileupload.FileUploadResponse.host';
...
/**
 *Called by the host to send selected objects to hosted-configurator client.
 */
export let CS_VARIANT_CONDITION_AUTHORING_SVC = 'splm.browserinterop.solutions.services.VariantConditionAuthoring.client';

/**
 *Called by the host to update hosted-configurator location.
 */
export let CS_UPDATE_HOSTED_CFG_LOCATION_SVC = 'splm.browserinterop.solutions.services.UpdateHostedCfgLocation.client';

/*
 *Called by the client (hosted-configurator) to send authored variant formulae to the host.
 */
export let HS_VARIANT_CONDITION_AUTHORING_SVC = 'splm.browserinterop.solutions.services.VariantConditionAuthoring.host';

/*
 *Called by the client (hosted-configurator) to send the variant rule uid to the host.
 */
export let HS_APPLY_CONFIGURATION_SVC = 'splm.browserinterop.solutions.services.ApplyConfiguration.host';

/*
 *Called by the client (hosted-configurator) to send exception to host.
 */
export let HS_HOSTED_CONFIGURATOR_EXCEPTION_SVC = 'splm.browserinterop.solutions.services.HostedConfiguratorException.host';

/**
 * Send loaded collaboration context info request to Host service FQN
 */
export let HS_HOST_SEND_LOADED_COLLABORATION_CONTEXT_NOTIFICATION = 'com.siemens.splm.client.processsimulate.hosted.services.refresh.CollaborationContextInfo';

/**
 * Send loaded collaboration context info to Host service FQN
 */
export let HS_HOST_SEND_LOADED_COLLABORATION_CONTEXT_SVC = 'com.siemens.splm.client.processsimulate.hosted.services.GetCollaborationContextInfo';
 ...
 * @memberof hostConst_Services
 */
export let VERSION_2023_06 = '_2023_06';
 ...
 * @memberof hostConst_Services
 */
export let VERSION_2024_03 = '_2024_03';
 ...
 * @memberof hostConst_Services
 */
export let VERSION_2024_06 = '_2024_06';
...
export default exports = {
    ...
    CS_VARIANT_CONDITION_AUTHORING_SVC,
    CS_UPDATE_HOSTED_CFG_LOCATION_SVC,
    HS_VARIANT_CONDITION_AUTHORING_SVC,
    HS_APPLY_CONFIGURATION_SVC,
    HS_HOSTED_CONFIGURATOR_EXCEPTION_SVC,
    HS_HOST_SEND_LOADED_COLLABORATION_CONTEXT_NOTIFICATION,
    HS_HOST_SEND_LOADED_COLLABORATION_CONTEXT_SVC,
    VERSION_2014_02,
    VERSION_2014_07,
    VERSION_2014_10,
    VERSION_2015_03,
