...
export let runningSpeedTest = async function( latencydisplayValue, uploadDisplayValue, downloadDisplayValue, goodConnection, poorConnection, connectionStatus ) {
    try {
        let latencyTime = await exports.latencyTest();
        let uploadSpeed =  exports.uploadTest();
        let downloadSpeed =  exports.downloadTest();
...
export let latencyTest = async function( latencydisp ) {
    ...
    try{
        ...
        let responseOne = await AwHTTPService.instance.post( browserUtils.getBaseURL() + 'performance/'  );
        ...
        let responseThree = await AwHTTPService.instance.post(  browserUtils.getBaseURL() + 'performance/' );
        ...
        let responseFour = await AwHTTPService.instance.post(  browserUtils.getBaseURL() + 'performance/' );
        ...
        let responseFive = await AwHTTPService.instance.post(  browserUtils.getBaseURL() + 'performance/' );
        ...
        let responseSix = await AwHTTPService.instance.post(  browserUtils.getBaseURL() + 'performance/' );
        ...
        let responseSeven = await AwHTTPService.instance.post(  browserUtils.getBaseURL() + 'performance/' );
...
export let uploadTest = async function( upTimeDisp, mockUploadData, isTestFileRunning ) {
    ...
    try {
        ...
        if( isTestFileRunning ) {
            util = require( 'util' );
            encoder = new util.TextEncoder();
            size1 = encoder.encode( JSON.stringify( result1 ) ).length / 1024 / 1024;
            size2 = encoder.encode( JSON.stringify( result2 ) ).length / 1024 / 1024;
            size3 = encoder.encode( JSON.stringify( result3 ) ).length / 1024 / 1024;
            size4 = encoder.encode( JSON.stringify( result4 ) ).length / 1024 / 1024;
        }else {
            size1 = new TextEncoder().encode( JSON.stringify( result1 ) ).length / 1024 / 1024;
            size2 = new TextEncoder().encode( JSON.stringify( result2 ) ).length / 1024 / 1024;
            size3 = new TextEncoder().encode( JSON.stringify( result3 ) ).length / 1024 / 1024;
            size4 = new TextEncoder().encode( JSON.stringify( result4 ) ).length / 1024 / 1024;
        }
...
export let downloadTest = async function( downTimeDisp, isTestFileRunning ) {
    ...
    try{
        ...
        if( isTestFileRunning ) {
            util = require( 'util' );
            encoder = new util.TextEncoder();
            size =  encoder.encode( JSON.stringify( downloadResponseOne.data ) ).length  / 1024 / 1024;
        }else {
            size =  new TextEncoder().encode( JSON.stringify( downloadResponseOne.data ) ).length  / 1024 / 1024;
        }
