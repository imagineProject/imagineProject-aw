...
export const awObjectSetListRenderFunction = ( { viewModel, objectSetData, isImage, showCheckbox, parentUid, subPanelContext } ) => {
    const { dataProviders, dndHandler } = viewModel;
    let commandContext = { dataProvider: dataProviders.ObjectSet_Provider, ...subPanelContext };
