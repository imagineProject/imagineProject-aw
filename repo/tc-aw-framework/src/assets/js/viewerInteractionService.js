 ...
 *
 * @param {String} viewerContextNamespace - registered viewer context name space
 * @param {String} factor - JSCom.EMM.factor lighting factor to set
 *
 */
export let setLightsIntensityFactor = function( viewerContextNamespace, factor ) {
    var viewerCtx = _viewerCtxSvc.getRegisteredViewerContext( viewerContextNamespace );
    return viewerCtx.getThreeDViewManager().setLightsIntensityFactor( factor );
};
