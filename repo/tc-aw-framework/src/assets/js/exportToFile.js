...
export let updateColumnList = function() {
    ...
    let eventData = {
        ...
        columnFilters: panelContext.columnFilters,
        searchSortCriteria: panelContext.searchSortCriteria
    };
...
export let hasAnyPropertySelected = function( allProperties ) {
    return allProperties.some(item => item.dbValue === true);
};
...
export const updateAllColumns = ( data ) => {
    ...
    output.minimumOnePropertySelected = hasAnyPropertySelected(allColumns);
    return output;
};

export const buildSubPanelContext = ( commandContext ) => {
    const columnFilters = commandContext?.columnProvider?.getColumnFilters();
    const searchSortCriteria = commandContext?.columnProvider?.getSortCriteria();
    return {
        columnFilters,
        searchSortCriteria,
        ...commandContext
...
exports = {
    ...
    refreshExportCtx,
    updateAllColumns,
    buildSubPanelContext,
    cleanup,
    hasAnyPropertySelected
};
