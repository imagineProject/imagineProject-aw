...
var ViewerDrawManager = function( viewerCtxNamespace, viewerView, viewerContextData ) {
    ...
    /**
     * Sets navcube faces as per orientation axis
     * @param {String} orientation orientation axis
     */
    self.setNavCubeFaces = function( orientation ) {
        _viewerView.drawMgr.setNavCubeFaces( orientation );
    };
};
