...
export let addSelectedMembers = function(  subPanelContext, data ) {
    ...
    var selectedProjects = subPanelContext.searchState && subPanelContext.searchState.pwaSelection ? subPanelContext.searchState.pwaSelection : [ subPanelContext.openedObject ];
