...
export let showStampVis = function( vmData ) {
    if( vmData.supportStampValue && vmData.supportStampValue.modelObjects ) {
        ...
        var printConfigNameProp = vmData.modProp.segments.props.dma1PrintConfigName;
        if( printConfigNameProp.dbValue && printConfigNameProp.selectedLovEntries ) {
            var uid = printConfigNameProp.selectedLovEntries[ 0 ].lovRowValue.uid;
