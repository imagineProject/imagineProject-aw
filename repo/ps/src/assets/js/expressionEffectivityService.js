...
export const clearUnitEffectivityContextAndResetState = ( path, value, destinationPanelId, data ) => {
    appCtxSvc.updatePartialCtx( 'expressionEffectivity.isOnlyUnitEffectivityApplicable', null );
    backActionMethod( destinationPanelId, data );
};
